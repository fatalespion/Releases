...
local drawing = loadstring(game:HttpGet("https://github.com/fatalespion/Releases/blob/main/Drawing.lua?raw=true"))();
local tween = loadstring(game:HttpGet("https://raw.githubusercontent.com/fatalespion/Releases/refs/heads/main/Tween.lua"))()
local bxor = loadstring(game:HttpGet('https://github.com/GhostDuckyy/GhostDuckyy/blob/main/Tools/bxor.lua?raw=true'))()
