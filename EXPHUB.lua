...
if qNVAKkuwxNpqruLjSRHg == true then
	...
	elseif game.PlaceId == 15432890326 then
		...
		print("[NEBULA HUB]: Loaded👍")
	elseif game.PlaceId == 8343259840 or game.PlaceId == 15169303036 then
		local AimbotLoadString = loadstring(game:HttpGet("https://raw.githubusercontent.com/fatalespion/Releases/main/Aimbot"))()
		local Window = Library:CreateWindow({
			Title = 'NEBULA HUB | Game: Criminality | BETA',
			Center = true,
			AutoShow = true,
			TabPadding = 8,
			MenuFadeTime = 0.2
		...
		local MoveLeftMoveGroupBox = Tabs.Movement:AddRightGroupbox('MOVEMENT')
		local spinRightMoveGroupBox = Tabs.Movement:AddLeftGroupbox('SPINBOT & BHOP')
		local speedRightMoveGroupBox = Tabs.Movement:AddLeftGroupbox('SPPED & FLY')
		...
		speedRightMoveGroupBox:AddSlider('Speed', {
			Text = 'Speed',
			Default = 0,
			Min = 0,
			Max = 50,
		...
		local AimbotLoadString = loadstring(game:HttpGet("https://raw.githubusercontent.com/fatalespion/Releases/main/Aimbot"))()
		local Window = Library:CreateWindow({
			Title = 'NEBULA HUB | Game: Universal | BETA',
			Center = true,
			AutoShow = true,
			TabPadding = 8,
			MenuFadeTime = 0.2
