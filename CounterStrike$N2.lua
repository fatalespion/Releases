...
OthersSettings:AddInput('uinamechange', {Default = '$N2', Numeric = false, Finished = false, Text = 'Window Title', Tooltip = 'Changes window title', Placeholder = '. . .'})
...
Library:Notify('Finished Loading! Welcome ' ..localPlayer.Name.. ' to $N2!');
